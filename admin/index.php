...
<head>
    ...
    <link href="vendor/summernote/summernote.min.css" rel="stylesheet" type="text/css">
		  ...
		  <div id="wrapper">
		    ...
		    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		      ...
		      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		        ...
		        <div class="sidebar-brand-text mx-3"><?=$_SESSION["hqs"]["nome"]?></div>
		      </a>
		      ...
		      <!-- Nav Item - Charts -->
		      <li class="nav-item">
		        <a class="nav-link" href="listar/usuarios">
		      ...
		      <footer class="sticky-footer bg-white">
		        <div class="container my-auto">
		          <div class="copyright text-center my-auto">
		            <span>Copyright &copy; Desenvolvido por Raquel M. - 2020</span>
		          </div>
		        </div>
		      </footer>
		      <!-- End of Footer -->
